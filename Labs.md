...
**SHOW** also How to create a NoSQL tables Using Terraform - use the [demo-lab-baggage-terraform.zip](./demo-lab-baggage-terraform.zip) provided.
...
(copy/paste the json Baggage document in Data text box for DEMO TABLE). 

###  Show data from the Console
